    ...
    secretLettersThemselves.innerHTML += `
        <a class="secret-letter-itself">
            <div class="secret-letter-itself-inner">
                <h3 class="secret-letter-itself-inner-title">The way she looked at me. This is the title of the letter. It can be longer than this too.</h3>
            </div>
            <div class="secret-letter-itself-buttons">
                <button class="secret-letter-itself-button">
